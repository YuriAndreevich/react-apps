...
function Sort({ activeSort, setActiveSort }) {
  ...
  const sortList = [
    { name: "популярности (по убыванию)", sort: "-rating", order: "desc" },
    { name: "популярности (по возрастанию)", sort: "rating", order: "asc" },
    { name: "цене (по убыванию)", sort: "-price", order: "desc" },
    { name: "цене (по возрастанию)", sort: "price", order: "asc" },
    { name: "алфавиту (по убыванию)", sort: "-title", order: "desc" },
    { name: "алфавиту (по возрастанию)", sort: "title", order: "asc" },
  ];
          ...
          <ul>
            {sortList.map((sortName, i) => (
              <li
                ...
                className={activeSort.sort === sortName.sort ? "active" : ""}
              >
                {sortName.name}
              </li>
            ))}
